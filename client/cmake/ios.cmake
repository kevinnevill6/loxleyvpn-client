...
set(GUARDO_IOS_APP_PROPERTIES
    MACOSX_BUNDLE_INFO_PLIST ${CMAKE_CURRENT_SOURCE_DIR}/ios/app/Info.plist.in
    MACOSX_BUNDLE_ICON_FILE "AppIcon"
    MACOSX_BUNDLE_INFO_STRING "GuardoVPN"
    MACOSX_BUNDLE_BUNDLE_NAME "GuardoVPN"
    ...
    XCODE_ATTRIBUTE_PRODUCT_NAME "GuardoVPN"
    XCODE_ATTRIBUTE_BUNDLE_INFO_STRING "GuardoVPN"
...
if(NOT GUARDO_IOS_UI_ONLY)
    list(APPEND GUARDO_IOS_APP_PROPERTIES
        XCODE_ATTRIBUTE_CODE_SIGN_ENTITLEMENTS "${CMAKE_CURRENT_SOURCE_DIR}/ios/app/main.entitlements"
        XCODE_EMBED_APP_EXTENSIONS networkextension
    )
endif()

set_target_properties(${PROJECT} PROPERTIES ${GUARDO_IOS_APP_PROPERTIES})
...
if(GUARDO_IOS_UI_ONLY)
    target_compile_definitions(${PROJECT} PRIVATE "GUARDO_IOS_UI_ONLY")
else()
